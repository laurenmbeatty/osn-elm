...
var _laurenmbeatty$osn_elm$PhotoGallery$BadStatus = function (a) {
	return {ctor: 'BadStatus', _0: a};
};
var _laurenmbeatty$osn_elm$PhotoGallery$NetworkError = {ctor: 'NetworkError'};
var _laurenmbeatty$osn_elm$PhotoGallery$Timeout = {ctor: 'Timeout'};
var _laurenmbeatty$osn_elm$PhotoGallery$BadUrl = function (a) {
	return {ctor: 'BadUrl', _0: a};
};
