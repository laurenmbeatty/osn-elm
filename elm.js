...
var _laurenmbeatty$osn_elm$PhotoGallery$main = _elm_lang$html$Html$beginnerProgram(
	{view: _laurenmbeatty$osn_elm$PhotoGallery$view, update: _laurenmbeatty$osn_elm$PhotoGallery$update, model: _laurenmbeatty$osn_elm$PhotoGallery$initialModel})();
var _laurenmbeatty$osn_elm$PhotoGallery$Model = F2(
	function (a, b) {
...
if (typeof _laurenmbeatty$osn_elm$PhotoGallery$main !== 'undefined') {
    _laurenmbeatty$osn_elm$PhotoGallery$main(Elm['PhotoGallery'], 'PhotoGallery', undefined);
}
